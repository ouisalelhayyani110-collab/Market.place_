...
CREATE TABLE medici (
    ...
    specializzazione_id INT          NOT NULL  COMMENT 'Specializzazione principale',
    email               VARCHAR(150),
    telefono            VARCHAR(20),
    foto                VARCHAR(255)           COMMENT 'Percorso file immagine profilo',
    biografia           TEXT                   COMMENT 'Testo breve per il carosello',
    bio_estesa          TEXT                   COMMENT 'Testo completo per la scheda profilo',
    esperienza          TEXT                   COMMENT 'Percorso professionale ed esperienze',
    attivo              BOOLEAN      NOT NULL DEFAULT TRUE,
    PRIMARY KEY (id),
...
CREATE TABLE pazienti (
    ...
    deleted_at          TIMESTAMP             DEFAULT NULL  -- 'Soft delete – richiesta cancellazione GDPR',
    PRIMARY KEY (id),
...
CREATE TABLE appuntamenti (
    ...
    note                TEXT              COMMENT 'Note libere del paziente alla prenotazione',
    cancellabile_fino   DATETIME          COMMENT 'Calcolato al momento della prenotazione (data_ora − 24h)',
    created_at          TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at          TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (id),
